...
class Data(object):
    ...
    def load_data(self, file_train, file_val, file_test, file_test_with_neg, file_psl=None, splitter='\t', line_end='\n'):
        ...
        self.test_triples_with_neg = self.load_triples(file_test_with_neg, splitter, line_end)

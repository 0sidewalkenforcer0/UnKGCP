...
def set_params(data_name, task, seed=0):
    ...
    elif data_name == 'ppi5k':
        params.VOCAB_SIZE = 4999
        params.REL_VOCAB_SIZE = 7
    ...
    if data_name == 'cn15k':
        ...
        if params.early_stop == 'valid_mse' or params.early_stop == 'valid_mae':
            ...
            params.BATCH_SIZE = 2048
            params.regularization = {'delta': 1, 'min': 1e-3, 'rel_trans': 1e-3, 'rel_scale': 1e-3,
                                     'inverse': 0, 'transitive': 0, 'composite': 0}  # no transition and composition rule for PPI5K
            params.GUMBEL_BETA = 0.01  # gumbel box
            params.NEG_RATIO = 1
